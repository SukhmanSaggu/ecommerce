          ...
          <div className="flex relative items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            {isLoggedIn ? (
              ...
              <>
                <Link
                  to="/login"
                  className="rounded-full border border-blue-600 px-4 py-1.5 text-sm font-semibold text-blue-600 transition-colors hover:bg-blue-50"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="ml-2 rounded-full bg-blue-600 px-4 py-1.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-700"
                >
                  Register
                </Link>
              </>
